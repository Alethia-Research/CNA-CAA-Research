...
% \begin{figure}[t]
% \centering
% \includegraphics[width=0.7\textwidth]{figures/\brandfig{cna_scaling_law_plot}.png}
...
% \begin{figure}[htbp]
% \centering
% \includegraphics[width=0.85\textwidth]{figures/\brandfig{periphery_alignment_diagram}.png}
...
Furthermore, we explicitly disclose that a matched learning rate sweep was not feasible within the hardware and compute budget of this study (executed entirely on standard single-accelerator Tesla T4 allocations) and is reserved for future work. Consequently, the following quantitative comparisons are presented as preliminary and descriptive, with matched-learning-rate controls pending:
